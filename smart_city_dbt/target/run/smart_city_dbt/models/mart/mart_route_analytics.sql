...
create or replace transient table SMART_CITY_DB.MART.mart_route_analytics
...
WITH route_fact AS (
    SELECT * FROM SMART_CITY_DB.STAGING.stg_route_hourly
),
...
traffic_grid AS (
    ...
    FROM SMART_CITY_DB.STAGING.stg_traffic_30min
