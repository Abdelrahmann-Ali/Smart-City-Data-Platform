...
create or replace transient table SMART_CITY_DB.MART.mart_fuel_environment
...
WITH fuel_fact AS (
    SELECT * FROM SMART_CITY_DB.STAGING.stg_fuel_daily
),
...
weather_daily AS (
    ...
    FROM SMART_CITY_DB.STAGING.stg_weather_hourly
